...
source_url: https://koinara.org/records/deploy-loop-hidden-costs/
raw_markdown_url: https://koinara.org/records/deploy-loop-hidden-costs.md
...
- Stable URL: https://koinara.org/records/deploy-loop-hidden-costs/
- Raw Markdown: https://koinara.org/records/deploy-loop-hidden-costs.md
- Date: 2026-05-13
- License: CC BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)
- Markdown citation: Koinara, [The deploy loop has hidden costs — and the cache is rarely where they live](https://koinara.org/records/deploy-loop-hidden-costs/) (2026-05-13), CC BY-SA 4.0.
