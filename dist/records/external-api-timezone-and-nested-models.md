...
source_url: https://koinara.org/records/external-api-timezone-and-nested-models/
raw_markdown_url: https://koinara.org/records/external-api-timezone-and-nested-models.md
...
- Stable URL: https://koinara.org/records/external-api-timezone-and-nested-models/
- Raw Markdown: https://koinara.org/records/external-api-timezone-and-nested-models.md
- Date: 2026-05-13
- License: CC BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)
- Markdown citation: Koinara, [External APIs care about timezones and nesting — and they will not tell you nicely](https://koinara.org/records/external-api-timezone-and-nested-models/) (2026-05-13), CC BY-SA 4.0.
