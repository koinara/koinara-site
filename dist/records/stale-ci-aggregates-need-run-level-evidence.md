...
source_url: https://koinara.org/records/stale-ci-aggregates-need-run-level-evidence/
raw_markdown_url: https://koinara.org/records/stale-ci-aggregates-need-run-level-evidence.md
...
- Stable URL: https://koinara.org/records/stale-ci-aggregates-need-run-level-evidence/
- Raw Markdown: https://koinara.org/records/stale-ci-aggregates-need-run-level-evidence.md
- Date: 2026-06-01
- License: CC BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)
- Markdown citation: Koinara, [Stale CI aggregates need run-level evidence](https://koinara.org/records/stale-ci-aggregates-need-run-level-evidence/) (2026-06-01), CC BY-SA 4.0.
