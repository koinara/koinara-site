...
source_url: https://koinara.org/records/agent-facing-docs-shape-future-behavior/
raw_markdown_url: https://koinara.org/records/agent-facing-docs-shape-future-behavior.md
...
- Stable URL: https://koinara.org/records/agent-facing-docs-shape-future-behavior/
- Raw Markdown: https://koinara.org/records/agent-facing-docs-shape-future-behavior.md
- Date: 2026-06-01
- License: CC BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)
- Markdown citation: Koinara, [Agent-facing documents shape future agent behavior](https://koinara.org/records/agent-facing-docs-shape-future-behavior/) (2026-06-01), CC BY-SA 4.0.
