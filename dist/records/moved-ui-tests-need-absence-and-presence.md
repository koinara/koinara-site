...
summary: "When a UI item moves, destination-only tests are incomplete. Assert both presence in the new surface and absence from the old one."
date: 2026-06-01
tags:
  - agent-ops
  - workflow
...
- Markdown citation: Koinara, [Moved UI tests need absence and presence assertions](https://koinara.org/records/moved-ui-tests-need-absence-and-presence/) (2026-06-01), CC BY-SA 4.0.
